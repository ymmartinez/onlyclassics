        ...
        <div className="col-8">
            ...
            {activeIndex === 0 && (
                ...
                <span className="p-float-label mt-5">
                    <InputText className='border-round-xl w-9' placeholder="Correo electrónico" />
            ...
            <div className="field m-0 col-12 md:4 w-6">
                <span className="p-float-label mt-4">
                    <InputText className='border-round-xl w-9' placeholder="Nombre" />
                    <label htmlFor="name">Nombre</label>
                </span>
            </div>
            <div className="field m-0 col-12 md:4 w-6">
                <span className="p-float-label mt-4">
                    <InputText className='border-round-xl w-9' placeholder="Apellido" />
                    <label htmlFor="surname">Apellido</label>
                </span>
            </div>
            <div className="field m-0 col-12 md:4 w-6">
                <span className="p-float-label mt-4">
                    <InputText className='border-round-xl w-9' placeholder="DNI" />
                    <label htmlFor="dni">DNI</label>
                </span>
            </div>
            <div className="field m-0 col-12 md:4 w-6">
                <span className="p-float-label mt-4">
                    <InputText className='border-round-xl w-9' placeholder="Teléfono" />
